...
const buttonVariants = cva(
  "flex items-center justify-center rounded-md font-medium text-white duration-300 disabled:bg-slate-400 disabled:hover:bg-slate-400 dark:text-black dark:disabled:bg-indigo-400 dark:disabled:hover:bg-indigo-400 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        // ** FILLED
